...
### 🟢 Babble – Real-time Chat App
Real-time chat application with live messaging and user interaction.

**Tech:** React, Node.js, Socket.io  
👉 Demonstrates real-time communication and state management  
Demo: https://chat-room-babble.onrender.com/

---

### 🟢 Community-Yad2 – Community Platform
Platform for creating and managing community posts - rent and sell items (CRUD system).

**Tech:** React, JavaScript, Firebase / Local Storage   
👉 Demonstrates data handling and user-focused design
Demo: https://community-yad2.vercel.app/

---

## 📫 Get in Touch
- [LinkedIn](https://www.linkedin.com/in/gai-shabtay-ba712217a/)
- [Email](mailto:sgaishab@gmail.com)
